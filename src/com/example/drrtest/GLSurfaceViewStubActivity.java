...
/**
 * A minimal activity for testing {@link android.opengl.GLSurfaceView}. Also
 * accepts non-blank renderers to allow its use for more complex tests.
 */
public class GLSurfaceViewStubActivity extends Activity {
	...
	/**
	 * To override the blank renderer, or other settings, these static set*
	 * methods must be called before onCreate() is called. If using
	 * ActivityInstrumentationTestCase2, that means the set methods need to be
	 * called before calling getActivity in the test setUp().
	 */
